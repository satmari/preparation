	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				...
				<div class="panel-heading"><span>Majstorica: <b>{{$leader->leader}}</b></span></div>
				...
				<div class="panel-body">
					<div class="col-lg-5">
						<span><b>Barcode</b></span>{!! Form::checkbox('Barcode', 'barcode', false, ['id' => 'check', 'class' => 'form-control']); !!}
					</div>
					<div class="col-lg-5 pull-right">
						<span><b>Carelabel</b></span>{!! Form::checkbox('Carelabel', 'carelabel', false, ['id' => 'check', 'class' => 'form-control']); !!}
					</div>
				</div>
				<div class="panel-body">
					<p>Comment: </p>
